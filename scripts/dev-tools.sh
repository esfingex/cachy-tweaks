...
log_info "Installing tmux, mise, kitty, and micro via pacman..."
pacman -S --needed --noconfirm tmux mise kitty micro || log_warn "Could not install all developer packages through pacman immediately."
